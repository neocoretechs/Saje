...
public class CyclicRunConfig extends AbstractRunConfig {
	...
	public String toXml() {
		...
		JAXBContext context;
		try {
			context = JAXBContext.newInstance(CyclicRunConfig.class);
	...
	private static CyclicRunConfig instance = null;
	public static CyclicRunConfig newInstance(License lic) throws IOException, DirectoryNotFoundException {
		if( instance == null ) {
			instance = new CyclicRunConfig(lic);
		}
		return instance;
	}
	
	// JAXB demands it
	public CyclicRunConfig() {}
	
	private CyclicRunConfig(License lic) throws IOException, DirectoryNotFoundException {
	...
	public static void main(String[] args) throws Exception {
		...
		CyclicRunConfig cfg = new CyclicRunConfig(lic);
